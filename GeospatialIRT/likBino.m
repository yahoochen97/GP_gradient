function [varargout] = likBino(N, hyp, y, mu, s2, inf, i)

% likBino - Binomial likelihood function for classification. The expression for 
% the likelihood is 
%   likBinom(t,N) =  C_n^k p^t(1-p)^{N-t}.
%
...
%
% Copyright (c) by Yehu Chen, 2023-04-10.
%
